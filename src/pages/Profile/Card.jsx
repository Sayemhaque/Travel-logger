...
import {FaArrowAltCircleRight, FaEdit, FaStar, FaTrash } from "react-icons/fa";
      ...
      <div className="px-4 py-2 md:w-8/12 bg-white">
        ...
        <div className="flex justify-between items-center">
          ...
          <FaArrowAltCircleRight
            title="See Details"
            className="text-lg
          text-slate-800 cursor-pointer hover:scale-105 duration-100"
          />
          <FaEdit
            title="Edit"
            className="text-lg
          text-green-500 cursor-pointer hover:scale-105 duration-100"
          />
           <FaTrash
            title="Delete"
            className="text-lg
          text-red-500 cursor-pointer hover:scale-105 duration-300"
          />
          </div>
        </div>
      </div>
