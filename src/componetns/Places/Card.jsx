...
const Card = ({ place }) => {
    return (
        <div className="rounded-lg  bg-white flex flex-col md:flex-row  gap-5 shadow-lg">
            {/* image */}
            <div>
            ...
            <div className="px-4 py-2 md:w-8/12">
              ...
              <Rating
                ...
                <FaArrowAltCircleRight title="see details" className="text-lg text-green-500 cursor-pointer"/>
                </div>
            </div>
        </div>
    );
